...
import {httpDelete, httpGet, httpPost, IApiResult, MSG_BOARD_API_URL} from "../index";
...
export function fetchListMsg(pageNum: number, pageSize: number): Promise<IApiResult<IPageInfo<IMsg>>> {
